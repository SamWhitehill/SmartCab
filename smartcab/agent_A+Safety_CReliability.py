...
def run(alpha=.005,epsilon =.025, tolerance=.01):
    ...
    sim = Simulator(env,update_delay=1.4,display=True,log_metrics=True,optimized=True)
...
if __name__ == '__main__':
    ...
    i=4
    alpha =.98# .005- (float(i)/1000)
    epsilon =.0015  #+(float(i)/100)
    tolerance =.9574 #-(float(i)/100)
